...
We usually post [the changelog](https://github.com/babel/babel/blob/master/CHANGELOG.md) in [Releases](https://github.com/babel/babel/releases), but I figured it could go as a post as well for minor versions.
...
- [trailing commas in functions](syntax-trailing-function-commas). (thanks to @bettiolo for the npm package)
