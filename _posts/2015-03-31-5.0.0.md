...
The [`runtime` transformer]() now has a companion [`es3.runtime` transformer](). This will allow you to use
methods such as `Array.isArray` etc in ES3 browsers such as IE8.
