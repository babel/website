...
[#5193](https://github.com/babel/babel/pull/5193) `babel-generator`: fix missing parens when function expressions is tag. ([@existentialism](https://github.com/existentialism))
