...
In this release: multiple improvements to the `react-constant-elements` plugin by ([@STRML](https://github.com/STRML)), some codegen optimizations, and lots of bug fixes!
...
The solution is just breaking up the expression in sets of 100.
