...
- 4500+ users on our [slack](babeljs.slack.com)
...
Hopefully, we can work more with TC-39 like we do with https://github.com/tc39/ecma262#current-proposals and our stage-x presets and plugins. We should look to run [test262](https://github.com/tc39/test262) with Babel.
...
You can also pass down `parserOpts.parser` and `generatorOps.generator`. This will enable the use of [recast](https://github.com/benjamn/recast) with Babel. 
...
And check out [Github](https://github.com/babel/babel/releases/tag/v6.16.0) for the rest of the changelog.
