...
For example: say we want to minify a file that contains an ES6 class and we want to target the latest version of Chrome.
...
```js
// ES6 code -> Babel -> Uglify/Babili -> Minified ES5 Code
