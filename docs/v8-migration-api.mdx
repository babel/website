...
:::info
Check out the [Babel 8 migration guide](v8-migration.mdx) first to learn about user-facing breaking changes.
:::
...
- Don't generate `TSParenthesizedType` unless `createParenthesizedExpression` is enabled ([#9546](https://github.com/babel/babel/issues/9546), [#12608](https://github.com/babel/babel/pull/12608))
  ...
  **Migration**: If you need information about parentheses, specify the [`createParenthesizedExpression`](./parser.mdx#options) parser option.
...
- Allow skipped `NodePath`s to be requeued ([#13291](https://github.com/babel/babel/pull/13291))
  ...
  `NodePath#requeue()` can requeue a skipped NodePath. This is actually a bugfix, but it causes an infinite loop in the [temporal dead zone](./plugin-transform-block-scoping.mdx#tdz) implementation of `@babel/plugin-transform-block-scoping` in Babel 7: it may break other plugins as well.
...
- Remove default export ([#17772](https://github.com/babel/babel/pull/17772))
  ...
  __Migration__: Migrate to the [`codeFrameColumns` API](./code-frame.mdx#codeframecolumns).
...
- Rename stage 4 plugin entries from `proposal-*` to `transform-*` in `plugins.json` ([#14976](https://github.com/babel/babel/pull/14976))
  ...
  __Migration__: For example, use `transform-class-properties` rather than `proposal-class-properties`. For a complete list of renamed plugin, see [Packages Renames section of Babel 8 migration](./v8-migration.mdx#package-renames).
...
- Remove the undocumented `isPluginRequired` API ([#17670](https://github.com/babel/babel/pull/17670)).
  ...
  __Migration__: This is an undocumented API. Use [`isRequired`](./helper-compilation-targets.mdx#isrequired) from `@babel/helper-compilation-targets` instead.
...
- Remove named export `environmentVisitor` ([#15550](https://github.com/babel/babel/pull/15550))
  ...
  __Migration__: Import it from [`@babel/helper-environment-visitor`](./helper-environment-visitor.mdx).
...
- Remove named export `skipAllButComputedKey` ([#15550](https://github.com/babel/babel/pull/15550))
  ...
  __Migration__: Use [`requeueComputedKeyAndDecorators`](./helper-environment-visitor.mdx#requeuecomputedkeyanddecorators) instead. Find and replace the following import and usage
...
- Remove `addImport` from plugin pass ([#15576](https://github.com/babel/babel/pull/15576))
  ...
  __Migration__: Use [`addNamed`](./helper-module-imports.mdx#import--named-as-_named--from-source) or [`addDefault`](./helper-module-imports.mdx#import-_default-from-source) from `@babel/helper-module-imports` instead.
