...
<div class="container docs-content">
  <div class="step-wizard">
    ...
    <div class="step step-setup">
      ...
      <p>Assuming you have installed the <a href="https://babeljs.io/docs/plugins/preset-es2015/">ES2015 Preset</a>, in order to enable it you have to define it in your <code>.babelrc</code> file, like this:
