...
_Even further_ than that, Babel is broken down into a number of core modules
...
> **_For future updates, follow [@thejameskyle](https://twitter.com/thejameskyle)
> on Twitter._**
...
What this does is _registers_ Babel in Node's module system and begins compiling
...
can enable things like _hot module reloading_ and other debugging utilities.
