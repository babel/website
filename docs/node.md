...
| `-o, --only [regex]`   | current working directory   | Include all files that match this regex when using the require hook. If both -i and -o are omitted, any file outside current working directory is ignored too. |
