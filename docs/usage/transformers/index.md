...
These are disabled by default, see [usage](#usage) for instructions on how to enable them.
 ...
 - [minification.inlineExpressions](/docs/usage/transformers/utility/inline-expressions)
 ...
 - [minification.removeConsole](/docs/usage/transformers/utility/remove-console)
 - [minification.removeDebugger](/docs/usage/transformers/utility/remove-debugger)
