...
Checkout the [babel-cli documentation](cli) to see more configuration options.
...
Checkout the [babel-core documentation](core) to see more configuration options.
