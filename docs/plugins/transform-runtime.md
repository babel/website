...
the following is generated: (maybe slighty different)
...
**NOTE:** Instance methods such as `"foobar".includes("foo")` will **not** work. (It would be modifying the `String.prototype`)
