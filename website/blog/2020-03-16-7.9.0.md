...
Special thanks go to [Luna Ruan](https://twitter.com/lunaruan) from the React Team ([Facebook](https://opensource.facebook.com/)) for contributing the new JSX transform, and [Rick Button](https://twitter.com/rickbutton) ([Bloomberg](https://www.techatbloomberg.com/)) who implements parser support for the [Record & Tuple](https://github.com/tc39/proposal-record-tuple) proposal!
