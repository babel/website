...
In summary (and please check the [RFC](https://github.com/reactjs/rfcs/blob/createlement-rfc/text/0000-create-element-changes.md) for for more information), the transform will:
