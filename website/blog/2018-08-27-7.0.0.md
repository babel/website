...
- Stage 1 (new): [Logical Assignment Operators](https://babeljs.io/docs/en/next/babel-plugin-proposal-logical-assignment-operators) (`a &&= b; a ||= b`)
- Stage 1 (new): [Nullish Coalescing Operator](https://babeljs.io/docs/en/next/babel-plugin-proposal-nullish-coalescing-operator) (`a ?? b`)
