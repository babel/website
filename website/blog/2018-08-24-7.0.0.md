...
Because of this, Babel has a huge influence on not just the future of the language itself but it's community and ecosystem. Even with all of this, Babel is just a community driven project by a couple of volunteers.
...
I myself joined a few months before the 6.0 release, which had it's own amount of controversy and backlash. A lot of the reception there led to existing maintainer burnout (including Sebastian, the creator) and a few of us that we're left sort of took up the reins. Like many maintainers, we accidently became
