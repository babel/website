...
> [Example on CodeSandbox](https://codesandbox.io/s/beautiful-sammet-msuiw?fontsize=18&hidenavigation=1&theme=dark&view=preview)
...
> [Example on CodeSandbox](https://codesandbox.io/embed/710-private-fields-in-in-c4chd?fontsize=14&hidenavigation=1&theme=dark&view=preview)
...
You can read more about it in the [proposal's description](https://github.com/tc39/proposal-private-fields-in-in/blob/master/README.md) and test this proposal by installing the `@babel/plugin-proposal-private-property-in-object` plugin and adding it to your Babel config. 
