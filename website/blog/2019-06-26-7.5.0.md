...
A fantastic example of this are the newest additions to the Babel organization: [Tan Li Hau](https://github.com/tanhauhau), who has been a great help in triaging issues and fixing bugs, and [Thiago Arrais](https://twitter.com/thiagoarrais), who has helped implementing the pipeline operator!
