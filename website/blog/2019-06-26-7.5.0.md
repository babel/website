...
Special thanks go to [Handshake](https://handshake.org/), a decentralized naming protocol for the web compatible with DNS, for donating 100.000 USD to Babel over the last year.
