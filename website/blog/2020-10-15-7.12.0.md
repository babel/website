...
> ℹ️ `@babel/plugin-syntax-module-attributes` will continue working until we release Babel 8.0.0, but it's highly recommended that you migrate to the new plugin.
