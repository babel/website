...
> We recommend using the [`babel.config.json`](config-files.md#project-wide-configuration) format or `babel.config.js`. [Babel itself is using it](https://github.com/babel/babel/blob/master/babel.config.js).
...
| Version | Changes |
| v7.8.0 | Support `babel.config.json` |
| v7.0.0 | Support `babel.config.js` |
</details>
...
or `babel.config.js` if you prefer a dynamic config.
```js
...
<details>
  <summary>History</summary>
| Version | Changes |
| v7.8.0 | Support `.babelrc.json` |
| v6.0.0 | Support `.babelrc` |
</details>
