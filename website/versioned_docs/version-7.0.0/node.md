...
| `-i, --ignore [regex]` | `node_modules`              | Ignore all files that match this regex when using the require hook. If both -i and -o are omitted, any file outside current working directory is ignored too. |
| `-o, --only [regex]`   | current working directory   | Include only the files that match this regex when using the require hook and exclude the other files. If both -i and -o are omitted, any file outside current working directory is ignored too. |
