...
const SetupHeader = () => {
  return (
    <div className="page-header text-center">
      <h1>
        <Translate id="setupPage.header" description="setup page - header">
          Using Babel
        </Translate>
      </h1>
      <p>
        <Translate
          id="setupPage.headerDesc"
          description="setup page - header desc"
        >
...
const SetupOptions = (props) => {
  ...
  const tools = customFields.tools as any[];
...
const StepInstallAndUsage = (props) => {
  ...
  const markdownsElement = (customFields.toolsMD as any[])
  ...
  const installation = (
    <Translate id="setupPage.step2" description="setup page - step 2">
      Installation
    </Translate>
  );
  const usage = (
    <Translate id="setupPage.step3" description="setup page - step 3">
      Usage
    </Translate>
  );
  return (
  ...
  return (
    <div className="step-setup" hidden={props.hidden}>
      <h2>
        ...
        <Translate id="setupPage.step4_1" description="setup page - step 4 one">
          Create
        </Translate>{" "}
        <code>babel.config.json</code>{" "}
        <Translate id="setupPage.step4_2" description="setup page - step 4 two">
          configuration file
        </Translate>
      </h2>
